...
!Local variables
 ...
 allocate(vsrl(nrl,4,4),vsol(nrl,4,4))
...
! Output for Abinit input using pspcod=8
 ...
 write(6,'(3a,4f10.5)') atsym,'    ONCVPSP-3.3.1' &
...
! write valence pseudo charge
 do ii=1,nrl
   write(6,'(i6,1p,4d21.13)') ii,rl(ii),rhol(ii),rhotael(ii),rhocl(ii)
 end do
...
&    '#relativistic version 3.3.1 12/12/2017', &
&    '#'
...
&    '#'
 ...
 write(6,'(a)') '#Echo of input data for oncvpsp-3.3.1'
