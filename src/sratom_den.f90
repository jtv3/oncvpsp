...
! University
!
! Modified by John Vinson, NIST 2023
! 
...
!
 subroutine sratom_den(na,la,ea,fa,rpk,nc,ncv,it,rhoc,rho,rhoin, sf_in, &
...
! Differs from sratom.f90 in that it takes an input density (rhoin) 
! and the corresponding electron count (sf_in). This allows frozen orbitals
! to be included.
...
!Input variables
 ...
 real(dp) :: zz, sf_in
 real(dp) :: fa(ncv),rr(mmax),rhoin(mmax)
 logical :: srel
