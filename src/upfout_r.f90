...
!Local variables
 ...
 integer :: dtime(8)
 real(dp) :: djjj
 real(dp) :: dmat(14,14),al,nrmsum,uurcut,fj
 ...
 allocate(rhol(nrl),rl(nrl),vkbl(nrl,2,4,2),vpl(nrl,5),rhomodl(nrl,5),uual(nrl,2,nv))
...
&      'fully-relativistic version 3.3.1 12/12/2017 by D. R. Hamann', &
