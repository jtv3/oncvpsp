...
!      SUBROUTINE DSYEV( JOBZ, UPLO, N, A, LDA, W, WORK, LWORK, INFO )
     ...
     if(info .ne. 0) then
      write(6,'(a,i4)') 'run_vkb_r: B matrix eigenvalue ERROR, info=',info
      stop
     end if
...
!      SUBROUTINE DSYEV( JOBZ, UPLO, N, A, LDA, W, WORK, LWORK, INFO )
    ...
    if(info .ne. 0) then
     write(6,'(a,i4)') 'run_vkb:_r sovl matrix eigenvalue ERROR, info=',info
     stop
    end if
...
!      SUBROUTINE DSYEV( JOBZ, UPLO, N, A, LDA, W, WORK, LWORK, INFO )
     ...
     if(info .ne. 0) then
      write(6,'(a,i4)') 'run_vkb_r: B^(-1)* matrix eigenvalue ERROR, info=',info
      stop
     end if
