...
!the residual energy for a set of q lower cutoffs
 ...
 eresidmin=0.0d0
!ACTIVATE THE FOLLLOWING 4 LINES TO RESTORE EXACT VERSION 3.2.3 RESULTS
! call old_optimize(nnull,nbas,pswf0_sb,pswf0_or,nqout,qout,&
!&              eresid0,eresiddot,eresidmat,&
!&              pswfnull_sb,pswfnull_or,qq(1,1),ps0norm,eresidmin,pswfopt_sb, &
!&              pswfopt_or,ekin_anal,eresq)

!COMMENT-OUT THE FOLLLOWING 4 LINES TO RESTORE EXACT VERSION 3.2.3 RESULTS
 call optimize(nnull,nbas,pswf0_sb,pswf0_or,nqout,qout,&
&              eresid0,eresiddot,eresidmat,&
&              pswfnull_sb,pswfnull_or,qq(1,1),ps0norm,eresidmin,pswfopt_sb, &
&              pswfopt_or,ekin_anal,eresq)

 write(6,'(a,1p,d10.2,a)') '    Residual KE error=', &
&      eresidmin,' Ha'
...
! call old_optimize(nnull,nbas,pswf0_sb,pswf0_or,nqout,qout,&
!&              eresid0,eresiddot,eresidmat,&
!&              pswfnull_sb,pswfnull_or,qq(2,2),ps0norm,oldres,pswfopt_sb, &
!&              pswfopt_or,ekin_anal,eresq)
